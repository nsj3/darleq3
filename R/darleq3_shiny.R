...
#' * 2: Once uploaded, selcted a sheet and click import.  A summary (number of samples & taxa) will be displayed in the Data summary box when upload is complete.
...
runDARLEQ <- function() {
  fn <- system.file("shiny_app/darleq3_shiny.R", package="darleq3")
