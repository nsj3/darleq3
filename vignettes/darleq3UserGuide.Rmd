...
For TDI3/4 and LTDI1/2 the following columns are also included:

* xxx.D2.Sum: Sum of taxa included in DARLEQ version 2 TDI calculations

* xxx.D2: TDI calculated using DARLEQ version 2 taxon list and indicator values

* xxx.Diff: Difference in TDI calculated using DARLEQ version 3 and 2 taxon lists and indicator values

* xxx.D2.EQR: EQR for DARLEQ version 2 TDI

* xxx.D2.Class: Status class for DARLEQ version 2 TDI

* Class.Diff: Indication if there is a difference in DARLEQ version 2 and 3 TDI status class
